...
% outputFolder  = 'X:' filesep 'SV1' filesep 'KM_14-10-09' filesep 'Mmu_E1_H2BmCherryRIKEN_TipTilt_TopScrew_20141009_200202.corrected' filesep 'Results' filesep 'Downsampled';
% timepoints    = 0:312;
% channels      = 0;
% resolution    = [6.5/16 6.5/16 6.5/16*5];
% padding       = 0;   % match z-size of all stacks to global maximum (computation of maximum depends on parameter fullSearch)
...
% inputString3  = '_CM00_CM01_CHN';
% inputString4  = '.fusedStack.corrected.klb';
% outputFolder  = 'X:' filesep 'SV1' filesep 'KM_15-04-03' filesep 'Mmu_E1_mKate2_0_20150403_151711.corrected' filesep 'Results' filesep 'Downsampled';
% timepoints    = 0:499;
% channels      = 0;
% resolution    = [6.5/16 6.5/16 6.5/16*5];
% padding       = 0;   % match z-size of all stacks to global maximum (computation of maximum depends on parameter fullSearch)
...
% inputString3  = '_CM00_CM01_CHN';
% inputString4  = '.fusedStack.corrected.klb';
% outputFolder  = 'R:' filesep 'SV1' filesep 'KM_15-10-26' filesep 'Mmu_E1_mKate2_20151026_180901.corrected' filesep 'Results' filesep 'Downsampled';
% timepoints    = 0:270;
% channels      = 0;
% resolution    = [6.5/16 6.5/16 6.5/16*5];
% padding       = 0;   % match z-size of all stacks to global maximum (computation of maximum depends on parameter fullSearch)
...
% inputString3  = '_CM00_CM01_CHN';
% inputString4  = '.fusedStack.corrected.klb';
% outputFolder  = 'R:' filesep 'SV1' filesep 'KM_15-11-17' filesep 'Mmu_E1_CATGAG1_20151117_175603.corrected' filesep 'Results' filesep 'Downsampled';
% timepoints    = 0:307;
% channels      = 0:1;
% resolution    = [6.5/16 6.5/16 6.5/16*5];
% padding       = 0;   % match z-size of all stacks to global maximum (computation of maximum depends on parameter fullSearch)
...
% inputString3  = '_CM00_CM01_CHN';
% inputString4  = '.fusedStack.corrected.klb';
% outputFolder  = 'R:' filesep 'SV1' filesep 'KM_16-01-12' filesep 'Mmu_H2BmCherry_20160112_135031.corrected' filesep 'Results' filesep 'Downsampled';
% timepoints    = 0:324;
% channels      = 0;
% resolution    = [6.5/16 6.5/16 6.5/16*5];
% padding       = 0;   % match z-size of all stacks to global maximum (computation of maximum depends on parameter fullSearch)
...
% inputString3  = '_CM00_CM01_CHN';
% inputString4  = '.fusedStack.corrected.klb';
% outputFolder  = 'X:' filesep 'SV1' filesep 'KM_16-03-15' filesep 'Mmu_E1_CAGTAG1_20160315_164340.corrected' filesep 'Results' filesep 'Downsampled';
% timepoints    = 0:291;
% channels      = 0:1;
% resolution    = [6.5/16 6.5/16 6.5/16*5];
% padding       = 0;   % match z-size of all stacks to global maximum (computation of maximum depends on parameter fullSearch)
...
% inputString3  = '_CM00_CM01_CHN';
% inputString4  = '.fusedStack.corrected.klb';
% outputFolder  = 'X:' filesep 'SV1' filesep 'KM_16-03-26' filesep 'Mmu_E1_mKate2_20160326_124921.corrected' filesep 'Results' filesep 'Downsampled';
% timepoints    = 0:368;
% channels      = 0;
% resolution    = [6.5/16 6.5/16 6.5/16*5];
% padding       = 0;   % match z-size of all stacks to global maximum (computation of maximum depends on parameter fullSearch)
...
% inputString3  = '_CM00_CM01_CHN';
% inputString4  = '.fusedStack.corrected.klb';
% outputFolder  = 'R:' filesep 'SV1' filesep 'KM_16-03-28' filesep 'Mmu_E1_H2BmCherry_20160328_170713.corrected' filesep 'Results' filesep 'Downsampled';
% timepoints    = 0:600;
% channels      = 0;
% resolution    = [6.5/16 6.5/16 6.5/16*5];
% padding       = 0;   % match z-size of all stacks to global maximum (computation of maximum depends on parameter fullSearch)
...
% inputString3  = '_CM00_CM01_CHN';
% inputString4  = '.fusedStack.corrected.klb';
% outputFolder  = 'R:' filesep 'SV1' filesep 'KM_15-10-26' filesep 'Mmu_E1_mKate2_Combined.corrected' filesep 'Results' filesep 'Downsampled';
% timepoints    = 0:649;
% channels      = 0;
% resolution    = [6.5/16 6.5/16 6.5/16*5];
% padding       = 0;   % match z-size of all stacks to global maximum (computation of maximum depends on parameter fullSearch)
...
% outputFolder  = 'R:' filesep 'SV1' filesep 'KM_16-12-15' filesep 'Mmu_E1_Fucci2_01_20161215_185256.corrected' filesep 'Results' filesep 'Downsampled';
% timepoints    = 0:192;
% channels      = 0:1;
% resolution    = [6.5/16 6.5/16 6.5/16*5];
...
% inputString1  = 'R:' filesep 'SV1' filesep 'KM_16-06-14' filesep 'Mmu_E1_Foxa2eGFPxTmCherry_01_20160614_121243.corrected' filesep 'Results' filesep 'TimeFused.geometricBlending' filesep 'Mmu_E1_Foxa2eGFPxTmCherry.TM';
% inputString2  = '_timeFused_blending' filesep 'SPM00_TM';
% inputString3  = '_CM00_CM01_CHN';
% inputString4  = '.fusedStack.klb';
% outputFolder  = 'R:' filesep 'SV1' filesep 'KM_16-06-14' filesep 'Mmu_E1_Foxa2eGFPxTmCherry_01_20160614_121243.corrected' filesep 'Results' filesep 'Downsampled';
% timepoints    = 0:258;
% channels      = 0:1;
% resolution    = [6.5/16 6.5/16 6.5/16*5];
% padding       = 1;   % match z-size of all stacks to global maximum (computation of maximum depends on parameter fullSearch)
...
% inputString3  = '_CM00_CM01_CHN';
% inputString4  = '.fusedStack.klb';
% outputFolder  = 'R:' filesep 'SV1' filesep 'KM_16-01-13' filesep 'Mmu_E1_GaleGFP_20160113_171610.corrected' filesep 'Results' filesep 'Downsampled';
% timepoints    = 0:322;
% channels      = 0;
% resolution    = [6.5/16 6.5/16 6.5/16*5];
% padding       = 1;   % match z-size of all stacks to global maximum (computation of maximum depends on parameter fullSearch)
...
% inputString1  = 'R:' filesep 'SV1' filesep 'KM_16-07-16' filesep 'Mmu_E1_GaleGFPxH2BmCherry_20160716_131448.corrected' filesep 'Results' filesep 'TimeFused' filesep 'Mmu_E1_GaleGFPxH2BmCherry.TM';
% inputString2  = '_timeFused_blending' filesep 'SPM00_TM';
% inputString3  = '_CM00_CM01_CHN';
% inputString4  = '.fusedStack.klb';
% outputFolder  = 'R:' filesep 'SV1' filesep 'KM_16-07-16' filesep 'Mmu_E1_GaleGFPxH2BmCherry_20160716_131448.corrected' filesep 'Results' filesep 'Downsampled';
% timepoints    = 0:271;
% channels      = 0:1;
% resolution    = [6.5/16 6.5/16 6.5/16*5];
% padding       = 1;   % match z-size of all stacks to global maximum (computation of maximum depends on parameter fullSearch)
...
% inputString1  = 'R:' filesep 'SV1' filesep 'KM_16-09-28' filesep 'Mmu_E1_mKate2nlsxH2BeGFP_01_20160928_162424.corrected' filesep 'Results' filesep 'TimeFused.Corrected' filesep 'Mmu_E1_mKate2nlsxH2BeGFP.TM';
% inputString2  = '_timeFused_blending' filesep 'SPM00_TM';
% inputString3  = '_CM00_CM01_CHN';
% inputString4  = '.fusedStack.corrected.klb';
% outputFolder  = 'R:' filesep 'SV1' filesep 'KM_16-09-28' filesep 'Mmu_E1_mKate2nlsxH2BeGFP_01_20160928_162424.corrected' filesep 'Results' filesep 'Downsampled';
% timepoints    = 0:292;
% channels      = 0:1;
% resolution    = [6.5/16 6.5/16 6.5/16*5];
% padding       = 1;   % match z-size of all stacks to global maximum (computation of maximum depends on parameter fullSearch)
