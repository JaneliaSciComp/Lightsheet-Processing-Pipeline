...
for i = 1:numel(timepoints)
    ...
    frames{i, 1} = readImage(['ProjectionsFusion' filesep 'Frames' filesep 'Fusion_SmallPSF_iter20.fusionSigma_5_2.TM' num2str(timepoint, '%.3d') '_xy.klb']);
    frames{i, 2} = readImage(['ProjectionsFusion' filesep 'Frames' filesep 'Fusion_SmallPSF_iter20.fusionSigma_5_2.TM' num2str(timepoint, '%.3d') '_xz.klb']);
    frames{i, 3} = readImage(['ProjectionsFusion' filesep 'Frames' filesep 'Fusion_SmallPSF_iter20.fusionSigma_5_2.TM' num2str(timepoint, '%.3d') '_yz.klb']);
    ...
    frames{i, 4} = readImage(['ProjectionsFusion' filesep 'Frames' filesep 'Fusion_LargePSF_iter50.fusionSigma_20_8.TM' num2str(timepoint, '%.3d') '_xy.klb']);
    frames{i, 5} = readImage(['ProjectionsFusion' filesep 'Frames' filesep 'Fusion_LargePSF_iter50.fusionSigma_20_8.TM' num2str(timepoint, '%.3d') '_xz.klb']);
    frames{i, 6} = readImage(['ProjectionsFusion' filesep 'Frames' filesep 'Fusion_LargePSF_iter50.fusionSigma_20_8.TM' num2str(timepoint, '%.3d') '_yz.klb']);
