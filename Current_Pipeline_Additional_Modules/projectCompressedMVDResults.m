...
if exist('ProjectionsMVD\Frames', 'dir') ~= 7
    mkdir('ProjectionsMVD\Frames');
end;
...
for i = 1:numel(timepoints)
    ...
    allDone = ...
        exist(['ProjectionsMVD\Frames\MVD_SmallPSF_iter20.TM' num2str(timepoint, '%.3d') '_xy.klb'], 'file') == 2 &&...
        exist(['ProjectionsMVD\Frames\MVD_SmallPSF_iter20.TM' num2str(timepoint, '%.3d') '_xz.klb'], 'file') == 2 &&...
        exist(['ProjectionsMVD\Frames\MVD_SmallPSF_iter20.TM' num2str(timepoint, '%.3d') '_yz.klb'], 'file') == 2;
    
    if allDone
        frames{i, 1} = readImage(['ProjectionsMVD\Frames\MVD_SmallPSF_iter20.TM' num2str(timepoint, '%.3d') '_xy.klb']);
        frames{i, 2} = readImage(['ProjectionsMVD\Frames\MVD_SmallPSF_iter20.TM' num2str(timepoint, '%.3d') '_xz.klb']);
        frames{i, 3} = readImage(['ProjectionsMVD\Frames\MVD_SmallPSF_iter20.TM' num2str(timepoint, '%.3d') '_yz.klb']);
        ...
        writeImage(frames{i, 1}, ['ProjectionsMVD\Frames\MVD_SmallPSF_iter20.TM' num2str(timepoint, '%.3d') '_xy.klb']);
        writeImage(frames{i, 2}, ['ProjectionsMVD\Frames\MVD_SmallPSF_iter20.TM' num2str(timepoint, '%.3d') '_xz.klb']);
        writeImage(frames{i, 3}, ['ProjectionsMVD\Frames\MVD_SmallPSF_iter20.TM' num2str(timepoint, '%.3d') '_yz.klb']);
    end;
    
    intensity(i, 2:6, 1) = [min(frames{i, 1}(:)), prctile(frames{i, 1}(:), 10), median(frames{i, 1}(:)), prctile(frames{i, 1}(:), 99.9), max(frames{i, 1}(:))];
    
    allDone = ...
        exist(['ProjectionsMVD\Frames\MVD_LargePSF_iter50.TM' num2str(timepoint, '%.3d') '_xy.klb'], 'file') == 2 &&...
        exist(['ProjectionsMVD\Frames\MVD_LargePSF_iter50.TM' num2str(timepoint, '%.3d') '_xz.klb'], 'file') == 2 &&...
        exist(['ProjectionsMVD\Frames\MVD_LargePSF_iter50.TM' num2str(timepoint, '%.3d') '_yz.klb'], 'file') == 2;
    
    if allDone
        frames{i, 4} = readImage(['ProjectionsMVD\Frames\MVD_LargePSF_iter50.TM' num2str(timepoint, '%.3d') '_xy.klb']);
        frames{i, 5} = readImage(['ProjectionsMVD\Frames\MVD_LargePSF_iter50.TM' num2str(timepoint, '%.3d') '_xz.klb']);
        frames{i, 6} = readImage(['ProjectionsMVD\Frames\MVD_LargePSF_iter50.TM' num2str(timepoint, '%.3d') '_yz.klb']);
        ...
        writeImage(frames{i, 4}, ['ProjectionsMVD\Frames\MVD_LargePSF_iter50.TM' num2str(timepoint, '%.3d') '_xy.klb']);
        writeImage(frames{i, 5}, ['ProjectionsMVD\Frames\MVD_LargePSF_iter50.TM' num2str(timepoint, '%.3d') '_xz.klb']);
        writeImage(frames{i, 6}, ['ProjectionsMVD\Frames\MVD_LargePSF_iter50.TM' num2str(timepoint, '%.3d') '_yz.klb']);
    end;
