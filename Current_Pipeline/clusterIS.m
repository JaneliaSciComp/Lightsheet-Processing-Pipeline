...
rootFolder   = 'U:\SiMView2.Processing\12-06-12\Dme_E1_His2ARFP_01_20120612_175853.corrected\Results\TimeFused';
...
if ~isempty(timepoints)
    ...
    parameterDatabase = [pwd '\jobParameters.interpolateStack.' timeString '.mat'];
    ...
    if localRun(1) ~= 1
        if jobMemory(1) == 1
            fileName = [...
                rootFolder '\' ...
                inputHeader1 num2str(timepoints(1), timeStamp) inputHeader2 '\' ...
